...
local init = function (configDevice, configMqtt, topics, createMessage, onConnect, onOffline, onMessageSuccess, onMessageFail)
	deviceId = configDevice.id

	mqttClient = mqtt.Client(configDevice.id, keepAlive, configDevice.user, configDevice.password)
